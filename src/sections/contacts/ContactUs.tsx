        ...
        <section id={'contact_us'}
            ...
            <div ref={ref}
                ...
                <KafelekKontakt>
                    ...
                    <a href="tel:+48726270500" className={"text-lg"}> 726 270 500</a>
                </KafelekKontakt>
                ...
                <div
                    ...
                    <div className={"flex flex-col items-center gap-y-5"}>
                        ...
                        <div className="grid grid-cols-2 gap-x-16 gap-y-4 text-xl text-[#FAEBDA]">
                            ...
                            <RowHour day={"Środa"} hour={"10:00 - 18:00"}/>
                            <RowHour day={"Czwartek"} hour={"8:00 - 20:00"}/>
                            <RowHour day={"Piątek"} hour={"8:00 - 20:00"}/>
                            <RowHour day={"Sobota"} hour={"7:00 - 15:00"}/>
                        ...
                        <div
                            ...
                            <Link
                                href={"https://www.instagram.com/kuzniameskichfryzur/"}>
                                <svg className={"w-10 h-10"} viewBox="0 0 24 24"
                                     xmlns="http://www.w3.org/2000/svg">
